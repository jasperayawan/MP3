...
<body>
            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="navbarToggleExternalContent">
                    <ul class="navbar-nav ms-auto list-unstyled w-100 gap-2 d-flex justify-content-end align-items-center">
                        ...
                        <li class="nav-item"><a href="./yourStay.html" class="nav-link text-decoration-none text-secondary fw-semibold">Your Stay</a></li>
                        <li class="nav-item"><a href="./hotelAmeneties.html" class="nav-link text-decoration-none text-secondary fw-semibold">Hotel Ameneties</a></li>
                        <li class="nav-item"><a href="./zambaongaTravel.html" class="nav-link text-decoration-none text-secondary fw-semibold">Visit</a></li>
                        <li class="nav-item"><a href="./contact.html" class="nav-link text-decoration-none text-secondary fw-semibold">Contact us</a></li>
    ...
    <main>
        <section class="zamboangaTravel">
            <div class="container">
                <div class="zamboangaTravel_content d-flex justify-content-center align-items-center">
                    <h1 class="text-white">Zamboanga Travel Guide</h1>
                </div>
            </div>
        </section>
    </main>
