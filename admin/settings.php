      ...
      <div class="main position-absolute">
        ...
        <div class="settings-content">
            <div class="px-4 position-relative">
                      ...
                      <div class="row">
                        <div class="col-lg-6">
                          ...
                          <div class="mb-4">
                            ...
                            <p class="card-text">
                              <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-telephone-fill text-success me-2" viewBox="0 0 16 16">
                        ...
                        <div class="col-lg-6">
                          <div class="mb-4">
                              ...
                              <p class="card-text">
                                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-facebook text-primary me-2" viewBox="0 0 16 16">
                                  <path d="M16 8.049c0-4.446-3.582-8.05-8-8.05C3.58 0-.002 3.603-.002 8.05c0 4.017 2.926 7.347 6.75 7.951v-5.625h-2.03V8.05H6.75V6.275c0-2.017 1.195-3.131 3.022-3.131.876 0 1.791.157 1.791.157v1.98h-1.009c-.993 0-1.303.621-1.303 1.258v1.51h2.218l-.354 2.326H9.25V16c3.824-.604 6.75-3.934 6.75-7.951z"/>
                                </svg>
                                <span id="facebook"></span>
                              </p>
                              <p class="card-text">
                                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-instagram text-danger me-2" viewBox="0 0 16 16">
                              ...
                              <p class="card-text">
                                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-twitter text-primary me-2" viewBox="0 0 16 16">
                ...
                <div class="card border-0 shadow-sm mb-4">
                    <div class="card-body">
                      <div class="mb-2 d-flex align-items-center justify-content-between">
                        ...
                        <button type="button" class="btn btn-dark shadow-none btn-sm" data-bs-toggle="modal" data-bs-target="#team-settings">
                      ...
                      <div class="row" id="team-data"> 
                        <div class="col-md-2 mb-3">
                          <div class="card bg-dark text-white border-0">
                            <img src="../assets/capcake.jpg" class="card-img">
                            <div class="card-img-overlay text-end">
                              <button type="button" class="btn btn-danger shdaow-none btn-sm ">
                ...
                <div class="modal fade" id="team-settings" data-bs-backdrop="static" data-bs-keyboard="true" tabindex="-1">
                  <div class="modal-dialog">
                    <form action="" id="team_settings_form">
                      <div class="modal-content">
                        <div class="modal-header">
